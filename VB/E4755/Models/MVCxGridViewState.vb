...
Public Class MVCxGridViewState
	Public Sub New(ByVal gridView As MVCxGridView)
		...
		TotalSummary = New Collection(Of MVCxSummaryItemState)()
	...
	Private privateTotalSummary As Collection(Of MVCxSummaryItemState)
	Public Property TotalSummary() As Collection(Of MVCxSummaryItemState)
		Get
			Return privateTotalSummary
		End Get
		Protected Set(ByVal value As Collection(Of MVCxSummaryItemState))
...
Public Class GridViewDataColumnStateCollection
	Inherits Collection(Of GridViewDataColumnState)
